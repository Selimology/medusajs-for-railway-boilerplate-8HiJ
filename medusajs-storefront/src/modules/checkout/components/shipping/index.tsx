                ...
                availableShippingMethods.map((option) => {
                  return (
                    <RadioGroup.Option
                      ...
                      value={option.id}
                      className={clx(
                        "flex items-center justify-between text-small-regular hover:cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:shadow-borders-interactive-with-active",
                        {
