...
To use the [Next.js Starter Template](https://medusajs.com/nextjs-commerce/), you should have a [Medusa server](https://github.com/rpuls/medusajs-backend-for-railway) setup and running locally on port 9000.
